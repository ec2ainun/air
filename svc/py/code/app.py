...
def hello():
    ...
    printData = "tooks ("+str(int(lama))+" ms) "+SERVICE_NAME+" --getRespondFrom--> "+UPSTREAM_URI+"\n"+str(kirim)
    return flask.Response(printData, headers=headers, status=200, mimetype='text/plain')
